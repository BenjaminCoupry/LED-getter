...
def preprocess(ps_images_paths, sliced=slice(None), threshold={'local':0, 'global':0, 'dilation':None, 'erosion':None}, meshroom_project=None, aligned_image_path=None, geometry_path=None, pose_path=None, black_image_path=None):
    ...
    validity_mask = validity.validity_mask(images, threshold['local'], threshold['global'], threshold['dilation'], threshold['erosion'], mask)
